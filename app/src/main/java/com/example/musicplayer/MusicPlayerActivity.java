...
public class MusicPlayerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public String[] Musicname={"圣诞星——周杰伦","稻香——周杰伦","告白气球——周杰伦",
            "兰亭序——周杰伦","蒲公英的约定——周杰伦","青花瓷——周杰伦","晴天——周杰伦"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                iv_music.setImageResource(fragment1.icons[position]);
            }
        }, filter);
    }
    ...
    public static Handler handler=new Handler(){//创建消息处理器对象
        ...
        public void handleMessage(Message msg){
            ...
            tv_total.setText(strMinute+":"+strSecond);//这里就显示了歌曲总时长

            minute=currentPosition/1000/60;//歌曲当前播放时长
